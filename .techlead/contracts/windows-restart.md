# C-WINDOWS_RESTART — Contract Frozen (windows-restart)
...
---
FROZEN SIGNATURE — windows-restart
Refer: .techlead/docker-parity-wave-plan.md WP-N/A
No new interface without lead authorization. Agents TRANSCRIBE, never invent.
