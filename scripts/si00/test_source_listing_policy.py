...
FAMILIES = ['CASES', 'EMPTY_CASES', 'DESCENDANT_CASES', 'SCRATCH_CASES', 'LINK_CASES', 'LISTING_CASES', 'DEST_ANCHOR_CASES', 'DEST_REPR_CASES']
...
class SourceListingPolicyTests(unittest.TestCase):
    ...
    def test_listing_controls_keep_prior_families_and_separate_suites(self):
        ...
        try:
            ...
            self.assertIn(r'listing_expected = r"test result: ok\. 17 passed;', text)
