...
LINUX = ['source_link_linux_raw_name_is_not_lossily_rewritten', 'source_link_linux_non_utf8_target_is_rejected_not_recoded', 'source_link_linux_pin_preserves_hostile_replacement_as_link']
